...
namespace RPG.Stats
{
    public class BaseStats : MonoBehaviour
    {
        ...
        [SerializeField] GameObject LevelUpPatricleEffect = null;
        [SerializeField] bool shouldUseModifiers = false;
        Experience experience;
        public event Action onLevelUp;
        public UnityEvent levelUpSoundEvent;
        ...
        {
            print(experience.GetExperience());
            ...
            if (newLevel > currentLevel.value)
            {
                ...
                LevelUpEffect();
                onLevelUp();
                levelUpSoundEvent.Invoke();
            }
        }

        private void LevelUpEffect()
        {
            Instantiate(LevelUpPatricleEffect, transform);
        }
